<%@ Page Title="Evaluation du stagiaire" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EvaluationStagiaire.aspx.cs" Inherits="SGSv2.Privée.Entreprise.EvaluationStagiaire" %>
            ...
            <div class="panel-content" style="color: white;">
                ...
                <asp:GridView HeaderStyle-CssClass="gridview-header" CssClass="gridview" ID="gvEtudiant" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="id_PERSRES" DataMember="DefaultView" DataSourceID="SqlDataSource1" CellPadding="4" ForeColor="#333333" GridLines="None" Width="970px" OnSelectedIndexChanged="gvEtudiant_SelectedIndexChanged">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="NomPrenom" HeaderText="Nom, Prenom" ReadOnly="True" SortExpression="NomPrenom" />
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:H2015_ProjetWeb_Groupe101_Equipe4ConnectionString %>" SelectCommand="P_FIND_Stagiaire_Entreprise" SelectCommandType="StoredProcedure">
                    <SelectParameters>
                        <asp:SessionParameter Name="idEntreprisePR" SessionField="idUtilisateur" Type="Int32" />
