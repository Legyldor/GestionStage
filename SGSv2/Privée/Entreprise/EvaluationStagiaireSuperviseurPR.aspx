<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EvaluationStagiaireSuperviseurPR.aspx.cs" Inherits="SGSv2.Privée.Entreprise.EvaluationStagiaireSuperviseur" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="maincontent" runat="server">
        ...
        <div class="panel">
            ...
            <div class="panel-content" style="color: white;">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:H2015_ProjetWeb_Groupe101_Equipe4ConnectionString %>" SelectCommand="P_SELECT_Stagiaires_Sup" SelectCommandType="StoredProcedure">
                    <SelectParameters>
                        <asp:SessionParameter Name="idutil" SessionField="idUtilisateur" Type="Int32" />
